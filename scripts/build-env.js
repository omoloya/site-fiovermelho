...
// 1. Geração do env.js dinâmico de produção
...
// 2. Minificação e Ofuscação dos Arquivos JS do Frontend (In-place) via Terser
...
// Executa a minificação após a geração do env.js
runMinification();
