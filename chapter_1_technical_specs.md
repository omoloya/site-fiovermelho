...
if (cleanId === "2" || parseInt(cleanId) === 2) {
    // Capítulo 2 mantém o override estático
    finalSynopsis = `Quando o seu pai te liga de madrugada...`;
    finalCover = "assets/capitulo_2.webp?v=2";
} else {
    // Capítulo 1 entra aqui, herdando os dados reais cadastrados no banco
