...
- [x] Project Documentation Update
    - [x] Update `README.md` to reflect the direct link layout, dynamic parameters, and auth mechanisms
    - [x] Update `developer_handover_guide.md` to match the exact live codebase features
